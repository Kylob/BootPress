...
{elseif $blog.page == 'category'}
  ...
  {$page->set([
    'title' => "{$category} at {$blog.name}",
    'description' => "View all of the posts at {$blog.name} that have been categorized under {$category}"
  ])}
  
  <div class="page-header"><h2>{$category} Category</h2></div><br>

...
$html .= $bp->navbar->open('Bootstrap Preview', 'top');
...
$html .= '<section id="icons">' . $icons . '</section>';

$html .= '<hr><div class="footer"><p>&copy; Company ' . date('Y') . '</p></div>';

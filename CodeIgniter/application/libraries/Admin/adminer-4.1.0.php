...
*
* @ln 345:35 added if(!is_null($l)) because of Fatal error: Call to a member function quote() on a non-object in .../adminer-4.1.0.php on line 50
* @ln 459:141 changed $rh=&$_SESSION to $rh=$_SESSION so that we get tags instead of numbers
*
...
q($P){global$l;if(!is_null($l))return$l->quote($P);}function
